        ...
        <div class="col-md-4" id="flight-paymentblock-left">
                    ...
                    <div class="card bg-payment-card shadow-sm">
                        <div class="card-header bg-payment-card-header card-header-payment pb-0">
                            <div class="d-flex justify-content-start align-items-center">
                                <p class="font-weight-normal card-title-payment f-16 card-text-payment-bold">Thông tin chuyến bay</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <p class="f-14 card-text-payment card-text-payment-bold">Khởi hành</p>
            ...
            <div class="row" id="flight-price-detail"><div class="col-12">
                    <div class="card bg-payment-card shadow-sm mt-2">
                        <div class="card-header bg-payment-card-header card-header-payment pb-0">
                            <div class="d-flex justify-content-start align-items-center">
                                <p class="font-weight-normal card-title-payment f-16 card-text-payment-bold">Thông tin giá</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row mb-0">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-borderless" style=" margin-bottom:0px !important;">
                                            <tbody>
                                                <tr>
                                                    <th class="text-left py-0"><span id="yetiskin_ucret" name="yetiskin_ucret"><c:out value='${yolcusayi.yetiskin_sayi}' /></span> Người lớn</th>
                                                    <td class="text-right py-0"><c:out value='${yolcusayi.yetiskin_sayi*ucusbilgileri.ucus_ucret}' /> ₺</td>
                                                </tr>
                                                <c:if test="${yolcusayi.cocuk_sayi!=0}">
                                                    <tr>
                                                        <th class="text-left py-0"><span id="cocuk_ucret" name="cocuk_ucret"><c:out value='${yolcusayi.cocuk_sayi}' /></span> Trẻ em</th>
                                                        <td class="text-right py-0"><c:out value='${yolcusayi.cocuk_sayi*ucusbilgileri.ucus_ucret}' /> ₺</td>
                                                    </tr>
                                                </c:if>    
                                                <tr>                                  
                                                    <td id="fiyat_goster">
                                                        <b class="card-text-payment">Tổng số tiền</b>                                      
                                                    </td>
                    ...
                    <div class="col-12 mb-2">
                        <div class="card shadow-sm">
                            <div class="card-header white card-header-payment pb-1">
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="font-weight-normal card-title-payment f-16 card-text-payment-bold">Thông tin liên hệ</p>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="yolcu_tel" class="">Điện thoại di động</label>
                ...
                <div class="row mb-4">
                    <div class="col-12 mb-2">
                        <div class="card shadow-sm">
                            <div class="card-header white card-header-payment pb-1">
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="font-weight-normal card-title-payment f-16 card-text-payment-bold">Thông tin hành khách</p>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12 col-12"> 
                                            <input type="hidden" id="yolcu_tip<c:out value = "${i}"/>" name="yolcu_tip<c:out value = "${i}"/>" value="0">
                                                <p class="font-weight-bold text-black-50"><c:out value = "${i}"/>.Hành khách (Người lớn)</p>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="yolcu_ad<c:out value = "${i}"/>">Bình thường</label>
                                                <input type="text" class="form-control" id="yolcu_ad<c:out value = "${i}"/>" name="yolcu_ad<c:out value = "${i}"/>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="yolcu_soyad<c:out value = "${i}"/>">Họ</label>
                                        ...
                                        <div class="col-md-6 mb-2 col-12">
                                            <div class="form-group">
                                                <label for="yolcu_tc<c:out value = "${i}"/>" class="">Số nhận dạng</label>
                                        ...
                                        <div class="col-md-6 mb-4 mb-lg-4 col-12">
                                            <div class="form-group">
                                                <label for="yolcu_tarih<c:out value = "${i}"/>" class="">Ngày sinh</label>
                ...
                <div class="row mb-4">   
                    <div class="col-12 mb-2">
                        <div class="card shadow-sm">
                            <div class="card-header white card-header-payment pb-1">
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="font-weight-normal card-title-payment f-16 card-text-payment-bold">Lựa chọn chỗ ngồi</p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                        ...
                                        <div class="form-group" id="divID">
                                            <c:forEach var = "k" begin = "1" end="${yolcusayi.cocuk_sayi+yolcusayi.yetiskin_sayi}">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <label for="yolcu_koltuk<c:out value = "${k}"/>" class="col-form-label"><c:out value = "${k}"/>. du khách</label>
                                                    ...
                                                    <div class="col-auto" style="padding-top:40px;">
                                                        <button type="button" id="<c:out value = "${k}"/>" onClick="koltuk_sec(this.id)" class="btn btn-dark">Lựa chọn</button>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                        </div>     
                    ...
                    <div class="mx-auto">
                        <button type="submit" class="btn btn-warning btn-rounded text-white selectbtn-go mb-5 mt-5">Hoàn tất quá trình đặt chỗ</button>
                    </div>
            </form>
