...
<section class="text-center mb-5">
    <form class="form-signin" action="gostergiris" method="post">
        ...
        <h1 class="h3 mb-3 font-weight-600">Chào mừng trở lại</h1>
        <%
        ...
        <label for="kullanici_sifre" class="sr-only">Mật khẩu</label>
        <input type="password" id="kullanici_sifre" name="kullanici_sifre" class="form-control" placeholder="Şifre" required>
                
        <button class="btn btn-lg btn-warning btn-block shadow-none" type="submit">Đăng nhập</button>
    </form>
        
    <div class="mt-3 mb-3" style="font-weight: 600" >
        <a href="sifremiunuttum" class="text-decoration-none" style="color: darkblue">Bạn quên mật khẩu?</a>
    </div>
    <div class="mt-3 mb-3">
        <span>Chưa phải là thành viên?</span><a href="uyeol" class="text-decoration-none" style="color: #FF7F00">Đăng ký</a>
    </div>
